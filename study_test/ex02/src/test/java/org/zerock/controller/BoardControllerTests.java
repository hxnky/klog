...
@WebAppConfiguration // 컨트롤러 테스트를 위한 어노테이션
...
public class BoardControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/register").param("title", "테스트 새 글 제목")
						.param("content", "테스트 새글 내용").param("writer", "user01"))
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "1").param("title", "테스트 수정 글 제목")
						.param("content", "테스트 수정글 내용").param("writer", "user03"))
				.andReturn().getModelAndView().getViewName();
